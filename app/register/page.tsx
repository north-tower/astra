...
async function Register() {
  ...
  return (
    <div className='isolate h-full overflow-hidden 
    pb-40'>

      <div className='mx-auto max-w-7xl px-6 pb-12 pt-16 text-white text-center lg:px-6'>
        <div className='mx-auto max-w-4xl'>
          <p className='mt-2 text-4xl font-bold tracking-tight sm:text-5xl text-indigo-600'>
        ...
        {/* <div className='relative'>
          ...
          md:-top-20 lg:-top-12 xl:top-0'>
            <ellipse cx={604} cy={512} fill='url(#radial-gradient)' 
            rx={604} ry={512} />
            <defs>
