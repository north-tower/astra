  ...
  return (
    <main className="">
      <div className="relative isolate pt-14 dark:bg-gray-900">
        ...
        overflow-hidden blur-3xl" aria-hidden="true">
          <div className="relative left-[calc[50%-11rem]] 
          aspect-[1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr 
          from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:"polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%,60.2% 624%, 52.4% 68.1%, 47.5% 58.3%,45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" 
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              dark:text-white shadow-sm hover:bg-indigo-500 focus-visible:outline 
...
{/* 
      ...
      overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
        ...
        sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" style={{
          clipPath:"polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%,60.2% 624%, 52.4% 68.1%, 47.5% 58.3%,45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" 
